      ...
      <main className="py-16 md:py-24">
        <div className="container mx-auto px-4">
            <div className="prose prose-lg max-w-4xl mx-auto dark:prose-invert prose-headings:font-headline prose-headings:font-light prose-h2:text-accent dark:prose-h2:text-white prose-h2:text-2xl prose-h2:mb-6 prose-h3:font-headline prose-h3:text-xl prose-h3:font-light prose-h4:text-lg prose-h4:font-light prose-p:text-muted-foreground prose-p:mb-6 prose-p:text-base prose-li:text-muted-foreground prose-li:mb-2.5 prose-strong:font-semibold prose-a:text-primary prose-a:no-underline hover:prose-a:underline">
                ...
                <p>Dax Software Solutions has not sold and will not sell your Personal Information. We may share and disclose your Personal Information for permitted business purposes in order to provide and/or market our products and services to you. The parties with whom we share Personal Information include our affiliates, service providers, our marketing business partners, and third parties to whom you or your agents authorize us to disclose your Personal Information in connection with products or services we provide to you or our clients.</p>
                <p>We may also share data with our marketing business partners to send communications through their services. Where we do share your information with third parties, we contract for appropriate levels of data protection are in place in accordance with the law. We may also be required to share Personal Information with government or law enforcement authorities if required by law or to protect our legal interests or in cases of suspected fraud or illegal activities, and/or if ordered by a subpoena, search warrant, or other court order.</p>
