        ...
        <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16 max-w-7xl mx-auto">
             ...
             <div className="grid md:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
                ...
                <div className="relative h-72 w-full">
                    <Image src="/career-img-2.jpg" alt="Diverse team working together at a table" fill className="rounded-lg object-cover shadow-lg" data-ai-hint="diverse team working" />
                </div>
            </div>
        </div>
      </section>
